            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`h-11 border-gray-200 focus:border-gray-400 focus:ring-0 ${errors.name ? "border-red-500 focus:border-red-500" : ""
                    }`}
                  {...register("name")}
                />
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`h-11 border-gray-200 focus:border-gray-400 focus:ring-0 ${errors.email ? "border-red-500 focus:border-red-500" : ""
                    }`}
                  {...register("email")}
                />
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`h-11 border-gray-200 focus:border-gray-400 focus:ring-0 ${errors.password ? "border-red-500 focus:border-red-500" : ""
                    }`}
                  {...register("password")}
                />
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`h-11 border-gray-200 focus:border-gray-400 focus:ring-0 ${errors.confirmPassword ? "border-red-500 focus:border-red-500" : ""
                    }`}
